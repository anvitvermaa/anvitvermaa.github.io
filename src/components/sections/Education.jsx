            ...
            <div className="card-flex items-stretch bg-[#141414] rounded shadow-xl overflow-hidden hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="card-left-col bg-[#1c1c1c] p-[20px] md:p-[25px] flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-[#777777] font-mono text-[10px] sm:text-[11px] md:text-xs mt-1">{edu.location}</p>
                </div>
              </div>
              ...
              <div className="flex-1 p-[12px] sm:p-[18px] md:p-[25px] min-w-0">
                ...
                <div
                  className="text-[#777777] text-[13px] sm:text-[14px] md:text-[15px] leading-relaxed [&>li]:mb-[10px] [&>li]:relative [&>li]:pl-[18px] [&>li]:before:content-['▹'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-[#ffffff]"
