...
const Hero = () => {
  return (
    <section id="about" className="flex flex-col justify-between min-h-screen max-w-[800px] mx-auto px-6 md:px-0 pt-32 pb-20">
      ...
      {/* Middle: Bio + Photo side by side */}
      <div className="hero-grid flex-grow my-8 items-center">
        <div style={{ minWidth: 0 }}>
          <div className="text-[#aaaaaa] text-[15px] md:text-[16px] max-w-[480px] leading-relaxed space-y-3">
            <p>
