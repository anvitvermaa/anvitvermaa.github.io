            ...
            <div className="card-flex items-stretch bg-[#141414] rounded shadow-xl overflow-hidden hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="card-left-col bg-[#1c1c1c] p-[20px] md:p-[25px] flex flex-col justify-between">
                <div>
                  ...
                  <div className="text-[#efefef] font-bold text-[13px] sm:text-[15px] md:text-2xl mb-2 md:mb-4">{job.range.split(' - ')[0]}</div>

                  <div className="font-mono text-[#ffffff] text-[10px] sm:text-[11px] md:text-xs mb-[2px] tracking-wider uppercase">To</div>
                  <div className="text-[#efefef] font-bold text-[13px] sm:text-[15px] md:text-2xl mb-3 md:mb-8">{job.range.split(' - ')[1] || 'Present'}</div>
                </div>

                <div>
                  <h4 className="text-[#efefef] font-bold text-[11px] sm:text-[14px] md:text-3xl leading-tight mb-1">{job.company}</h4>
              ...
              <div className="flex-1 p-[10px] sm:p-[18px] md:p-[25px] min-w-0 overflow-hidden">
                <h3 className="text-[15px] sm:text-[18px] md:text-[32px] font-bold text-[#efefef] mb-[10px] md:mb-[20px] group-hover:text-[#ffffff] transition-colors duration-300">
                  {job.title}
                </h3>

                <div
                  className="text-[#aaaaaa] text-[14px] sm:text-[14px] md:text-[22px] leading-relaxed [&>li]:mb-[10px] [&>li]:relative [&>li]:pl-[18px] [&>li]:before:content-['▹'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-[#ffffff]"
